...
public class SignInPage extends BaseInitedPage {
	...
	public static String CONF_IGNORE_BAD_SSL = "oauth2.ignore_bad_ssl";
	...
	private void prepareConnection(URLConnection connection) {
		...
		Boolean ignoreBadSSL = configurationDao.getConfValue(CONF_IGNORE_BAD_SSL, String.class, "no").equals("yes");

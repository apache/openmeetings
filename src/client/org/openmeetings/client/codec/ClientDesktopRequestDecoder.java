 ...
 *
 */
public class ClientDesktopRequestDecoder extends CumulativeProtocolDecoder {
	
	private static Logger log = Logger.getLogger(ClientDesktopRequestDecoder.class);

	private static final String DECODER_STATE_KEY = ClientDesktopRequestDecoder.class.getName() + ".STATE";

...
//		Fieldmanagment.getInstance().addFourFieldValues("orgvalue_orgname", 172, "Organisation hinzufuegen", "add organisation", "add organisation", "add organisation");
//		Fieldmanagment.getInstance().addFourFieldValues("orgvalue_orgname", 173, "Organisation hinzufuegen", "add organisation", "add organisation", "add organisation");
//		Fieldmanagment.getInstance().addFourFieldValues("orgvalue_userwin", 174, "abbrechen", "cancel", "cancel", "cancel");
//		Fieldmanagment.getInstance().addFourFieldValues("orgvalue_userwin", 175, "hinzufuegen", "add", "add", "add");
...
//		Fieldmanagment.getInstance().addFourFieldValues("orgvalue_userlistadd", 178, "Benutzer hinzufuegen", "add user", "add user", "add user");
...
//		Fieldmanagment.getInstance().addFourFieldValues("orgvalue_userwinheader", 180, "Benutzer hinzufuegen", "add user", "add user", "add user");
...
//		Fieldmanagment.getInstance().addFourFieldValues("loginwin_chooseorganisationbtn", 185, "auswaehlen", "enter", "enter", "enter");
//		Fieldmanagment.getInstance().addFourFieldValues("navi_roomadmin", 186, "Konferenzraeume", "conferencerooms", "conferencerooms", "conferencerooms");
//		Fieldmanagment.getInstance().addFourFieldValues("roomadmin_header", 187, "Konferenzraeume", "Conferencerooms", "Conferencerooms", "Conferencerooms");
...
//		Fieldmanagment.getInstance().addFourFieldValues("roomadmin_header", 190, "oeffentlich", "public", "public", "public");
...
//		Fieldmanagment.getInstance().addFourFieldValues("roomadmin_header", 192, "Konferenzraeume", "Conferencerooms", "Conferencerooms", "Conferencerooms");
...
//		Fieldmanagment.getInstance().addFourFieldValues("roomvalue_ispublic", 195, "oeffentlich", "public", "public", "public");
...
//		Fieldmanagment.getInstance().addFourFieldValues("whiteboard_openicon", 198, "oeffnen", "load", "load", "load");
...
//		Fieldmanagment.getInstance().addFourFieldValues("loadwml_confirmmess", 211, "Zeichnbrett leeren, alle bisherigen aenderungen gehen damit verloren!", "clear drawarea, all data on whiteboard will be lost", "clear drawarea, all data on whiteboard will be lost", "clear drawarea, all data on whiteboard will be lost");
//		Fieldmanagment.getInstance().addFourFieldValues("loadwml_confirmmess2", 212, "Bestaetigung anfordern vor dem Laden einer Datei", "Confirm before loading a file", "Confirm before loading a file", "Confirm before loading a file");
...
//		Fieldmanagment.getInstance().addFourFieldValues("send_invitationwin_recipient", 216, "Empfaenger", "Recipient", "Recipient", "Recipient");
...
//		Fieldmanagment.getInstance().addFourFieldValues("invited_userwin_subject", 222, "Nickname fuer diese Konference", "Your nickname for this conference", "Your nickname for this conference", "Your nickname for this conference");

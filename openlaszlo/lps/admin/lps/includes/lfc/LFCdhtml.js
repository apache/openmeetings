...
{
if(!$1.__LZdeleted){
var $lzsc$xwf4zl="$lzc$set_"+$2;if(Function["$lzsc$isa"]?Function.$lzsc$isa($1[$lzsc$xwf4zl]):$1[$lzsc$xwf4zl] instanceof Function){
$1[$lzsc$xwf4zl]($4)
}else{
$1[$2]=$4;var $lzsc$gszzwq=$1["on"+$2];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$gszzwq):$lzsc$gszzwq instanceof LzEvent){
if($lzsc$gszzwq.ready){
$lzsc$gszzwq.sendEvent($4)
...
{
if(!this.__LZdeleted){
var $lzsc$ffrihu="$lzc$set_"+$0;if(Function["$lzsc$isa"]?Function.$lzsc$isa(this[$lzsc$ffrihu]):this[$lzsc$ffrihu] instanceof Function){
this[$lzsc$ffrihu]($6)
}else{
this[$0]=$6;var $lzsc$3dnr4h=this["on"+$0];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$3dnr4h):$lzsc$3dnr4h instanceof LzEvent){
if($lzsc$3dnr4h.ready){
$lzsc$3dnr4h.sendEvent($6)
...
{
if(!this.__LZdeleted){
var $lzsc$mmqevv="$lzc$set_"+$0;if(Function["$lzsc$isa"]?Function.$lzsc$isa(this[$lzsc$mmqevv]):this[$lzsc$mmqevv] instanceof Function){
this[$lzsc$mmqevv]($3)
}else{
this[$0]=$3;var $lzsc$mmz40l=this["on"+$0];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$mmz40l):$lzsc$mmz40l instanceof LzEvent){
if($lzsc$mmz40l.ready){
$lzsc$mmz40l.sendEvent($3)
...
var $5=$3?this[$0]+$1:$1;{
if(!this.__LZdeleted){
var $lzsc$h3dpek="$lzc$set_"+$0;if(Function["$lzsc$isa"]?Function.$lzsc$isa(this[$lzsc$h3dpek]):this[$lzsc$h3dpek] instanceof Function){
this[$lzsc$h3dpek]($5)
}else{
this[$0]=$5;var $lzsc$rh9cip=this["on"+$0];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$rh9cip):$lzsc$rh9cip instanceof LzEvent){
if($lzsc$rh9cip.ready){
$lzsc$rh9cip.sendEvent($5)
}}}}};return null
...
{
if(!this.__LZdeleted){
var $lzsc$xgabuj="$lzc$set_"+$0;if(Function["$lzsc$isa"]?Function.$lzsc$isa(this[$lzsc$xgabuj]):this[$lzsc$xgabuj] instanceof Function){
this[$lzsc$xgabuj]($2)
}else{
this[$0]=$2;var $lzsc$jfuiwx=this["on"+$0];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$jfuiwx):$lzsc$jfuiwx instanceof LzEvent){
if($lzsc$jfuiwx.ready){
$lzsc$jfuiwx.sendEvent($2)
}}}}}}},"presentTypeValue",function($0,$1,$2,$3){
...
};LzTextSprite.prototype.multline=false;LzTextSprite.prototype.setMultiline=function($0){
...
var $1=$0?null:this.__cancelhandler;this.__LZdiv.onselectstart=$1
}else{
...
this.resize=$0;this.applyCSS("overflow",this.resize?"":"hidden","scrolldiv")
...
}};LzTextSprite.prototype.__widthcss=0;LzTextSprite.prototype.setWidth=function($0){
if($0==null||$0<0||isNaN($0))return;var $1=LzSprite.prototype.setWidth.call(this,$0);if($1==null)return;var $2=$0>=this.__wpadding?$0-this.__wpadding:0;if(this.scrolling){
...
};LzTextSprite.prototype.__heightcss=0;LzTextSprite.prototype.setHeight=function($0){
if($0==null||$0<0||isNaN($0))return;var $1=LzSprite.prototype.setHeight.call(this,$0);if($1==null)return;var $2=$0>=this.__hpadding?$0-this.__hpadding:0;if(this.scrolling||this.classname=="lzswfinputtextmultiline"){
$2+=this.quirks.scrollbar_width
...
}};LzInputTextSprite.prototype.__iwidthcss=0;LzInputTextSprite.prototype.setWidth=function($0){
if($0==null||$0<0||isNaN($0))return;var $1=LzTextSprite.prototype.setWidth.call(this,$0);if($1==null)return;if(this.quirks.fix_clickable&&$1!==null){
$1=this.CSSDimension($1);if($1!==this.__iwidthcss){
this.__iwidthcss=$1;this.__LZinputclickdiv.style.width=$1
}}};LzInputTextSprite.prototype.__iheightcss=0;LzInputTextSprite.prototype.setHeight=function($0){
if($0==null||$0<0||isNaN($0))return;var $1=LzTextSprite.prototype.setHeight.call(this,$0);if($1==null)return;if(this.quirks.fix_clickable&&$1!==null){
...
if(this[$0]){
if(!this.__LZdeleted){
var $lzsc$pkrjqt="$lzc$set_"+$0;if(Function["$lzsc$isa"]?Function.$lzsc$isa(this[$lzsc$pkrjqt]):this[$lzsc$pkrjqt] instanceof Function){
this[$lzsc$pkrjqt]($1)
}else{
this[$0]=$1;var $lzsc$ww9lwo=this["on"+$0];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$ww9lwo):$lzsc$ww9lwo instanceof LzEvent){
if($lzsc$ww9lwo.ready){
$lzsc$ww9lwo.sendEvent($1)
...
$2.update($0);{
var $lzsc$ams7cn=($3-$2[$0+"offset"])/$2[$0+"scale"];if(!this.__LZdeleted){
var $lzsc$h7pm4x="$lzc$set_"+$0;if(Function["$lzsc$isa"]?Function.$lzsc$isa(this[$lzsc$h7pm4x]):this[$lzsc$h7pm4x] instanceof Function){
this[$lzsc$h7pm4x]($lzsc$ams7cn)
}else{
this[$0]=$lzsc$ams7cn;var $lzsc$cerv8s=this["on"+$0];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$cerv8s):$lzsc$cerv8s instanceof LzEvent){
if($lzsc$cerv8s.ready){
$lzsc$cerv8s.sendEvent($lzsc$ams7cn)
}}}}}}else if($0=="width"||$0=="height"){
var $4=$0=="width"?"x":"y";$2.update($4);var $5=$4+"scale";{
var $lzsc$xzmh48=$3*$1[$5]/$2[$5]/this[$5];if(!this.__LZdeleted){
var $lzsc$rcelz2="$lzc$set_"+$0;if(Function["$lzsc$isa"]?Function.$lzsc$isa(this[$lzsc$rcelz2]):this[$lzsc$rcelz2] instanceof Function){
this[$lzsc$rcelz2]($lzsc$xzmh48)
}else{
this[$0]=$lzsc$xzmh48;var $lzsc$8aybqh=this["on"+$0];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$8aybqh):$lzsc$8aybqh instanceof LzEvent){
if($lzsc$8aybqh.ready){
$lzsc$8aybqh.sendEvent($lzsc$xzmh48)
...
this["context"]=$0;var $lzsc$vqei35=this["oncontext"];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$vqei35):$lzsc$vqei35 instanceof LzEvent){
if($lzsc$vqei35.ready){
$lzsc$vqei35.sendEvent($0)
...
$0=!(!$0);this.multiline=$0;this.tsprite.setMultiline($0)
},"resize",true,"$lzc$set_resize",function($0){
$0=!(!$0);this.resize=$0;this.tsprite.setResize($0)
...
{
var $lzsc$9x12gm=Number(this.from);if(!$0.__LZdeleted){
var $lzsc$c14v28="$lzc$set_"+$1;if(Function["$lzsc$isa"]?Function.$lzsc$isa($0[$lzsc$c14v28]):$0[$lzsc$c14v28] instanceof Function){
$0[$lzsc$c14v28]($lzsc$9x12gm)
}else{
$0[$1]=$lzsc$9x12gm;var $lzsc$rw90lz=$0["on"+$1];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$rw90lz):$lzsc$rw90lz instanceof LzEvent){
if($lzsc$rw90lz.ready){
$lzsc$rw90lz.sendEvent($lzsc$9x12gm)
}}}}}};if($2[$1]==null){
$2[$1]=Number($0[$1])
};if(this.relative){
this.to=this.origto
...
$2[$1]+=Number($3-$2[$1]);{
var $lzsc$tsfamw=Number($3);if(!$0.__LZdeleted){
var $lzsc$3eux0f="$lzc$set_"+$1;if(Function["$lzsc$isa"]?Function.$lzsc$isa($0[$lzsc$3eux0f]):$0[$lzsc$3eux0f] instanceof Function){
$0[$lzsc$3eux0f]($lzsc$tsfamw)
}else{
$0[$1]=$lzsc$tsfamw;var $lzsc$dymhcn=$0["on"+$1];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$dymhcn):$lzsc$dymhcn instanceof LzEvent){
if($lzsc$dymhcn.ready){
$lzsc$dymhcn.sendEvent($lzsc$tsfamw)
}}}}}};if(!this.relative){
...
if(!$0.__LZdeleted){
var $lzsc$m0c6yu="$lzc$set_"+$1;if(Function["$lzsc$isa"]?Function.$lzsc$isa($0[$lzsc$m0c6yu]):$0[$lzsc$m0c6yu] instanceof Function){
$0[$lzsc$m0c6yu]($3)
}else{
$0[$1]=$3;var $lzsc$rdgmyo=$0["on"+$1];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$rdgmyo):$lzsc$rdgmyo instanceof LzEvent){
if($lzsc$rdgmyo.ready){
$lzsc$rdgmyo.sendEvent($3)
}}}}}};this.__LZhalt()
...
var $lzsc$srwh6y=$4[$5]+($3-this.currentValue);if(!$4.__LZdeleted){
var $lzsc$lmvubw="$lzc$set_"+$5;if(Function["$lzsc$isa"]?Function.$lzsc$isa($4[$lzsc$lmvubw]):$4[$lzsc$lmvubw] instanceof Function){
$4[$lzsc$lmvubw]($lzsc$srwh6y)
}else{
$4[$5]=$lzsc$srwh6y;var $lzsc$1vb3cl=$4["on"+$5];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$1vb3cl):$lzsc$1vb3cl instanceof LzEvent){
if($lzsc$1vb3cl.ready){
$lzsc$1vb3cl.sendEvent($lzsc$srwh6y)
...
{
if(!$5.__LZdeleted){
var $lzsc$8mhznz="$lzc$set_"+$6;if(Function["$lzsc$isa"]?Function.$lzsc$isa($5[$lzsc$8mhznz]):$5[$lzsc$8mhznz] instanceof Function){
$5[$lzsc$8mhznz]($7)
}else{
$5[$6]=$7;var $lzsc$1r8jut=$5["on"+$6];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$1r8jut):$lzsc$1r8jut instanceof LzEvent){
if($lzsc$1r8jut.ready){
$lzsc$1r8jut.sendEvent($7)
}}}}}}};return $3
},"destroy",function(){
...
var $lzsc$muu8s7=this.axis;var $lzsc$4f1wu5=this.totalsize;if(!$6.__LZdeleted){
var $lzsc$dcwi0o="$lzc$set_"+$lzsc$muu8s7;if(Function["$lzsc$isa"]?Function.$lzsc$isa($6[$lzsc$dcwi0o]):$6[$lzsc$dcwi0o] instanceof Function){
$6[$lzsc$dcwi0o]($lzsc$4f1wu5)
}else{
$6[$lzsc$muu8s7]=$lzsc$4f1wu5;var $lzsc$rfqb9j=$6["on"+$lzsc$muu8s7];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$rfqb9j):$lzsc$rfqb9j instanceof LzEvent){
if($lzsc$rfqb9j.ready){
$lzsc$rfqb9j.sendEvent($lzsc$4f1wu5)
...
{
var $lzsc$2823it=$7*$6-this.spacing;if(!$2.__LZdeleted){
var $lzsc$589i1v="$lzc$set_"+$5;if(Function["$lzsc$isa"]?Function.$lzsc$isa($2[$lzsc$589i1v]):$2[$lzsc$589i1v] instanceof Function){
$2[$lzsc$589i1v]($lzsc$2823it)
}else{
$2[$5]=$lzsc$2823it;var $lzsc$x71l3b=$2["on"+$5];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$x71l3b):$lzsc$x71l3b instanceof LzEvent){
if($lzsc$x71l3b.ready){
$lzsc$x71l3b.sendEvent($lzsc$2823it)
...
this.clones[$f]=$g;{
var $lzsc$a27vyy=($f+$8)*$6;if(!$g.__LZdeleted){
var $lzsc$6ctyup="$lzc$set_"+$4;if(Function["$lzsc$isa"]?Function.$lzsc$isa($g[$lzsc$6ctyup]):$g[$lzsc$6ctyup] instanceof Function){
$g[$lzsc$6ctyup]($lzsc$a27vyy)
}else{
$g[$4]=$lzsc$a27vyy;var $lzsc$35hf0a=$g["on"+$4];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$35hf0a):$lzsc$35hf0a instanceof LzEvent){
if($lzsc$35hf0a.ready){
$lzsc$35hf0a.sendEvent($lzsc$a27vyy)
...
var $lzsc$1s0x9e=this.axis;if(!$m.__LZdeleted){
var $lzsc$kp79jz="$lzc$set_"+$lzsc$1s0x9e;if(Function["$lzsc$isa"]?Function.$lzsc$isa($m[$lzsc$kp79jz]):$m[$lzsc$kp79jz] instanceof Function){
$m[$lzsc$kp79jz]($n)
}else{
$m[$lzsc$1s0x9e]=$n;var $lzsc$9o3qtf=$m["on"+$lzsc$1s0x9e];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$9o3qtf):$lzsc$9o3qtf instanceof LzEvent){
if($lzsc$9o3qtf.ready){
$lzsc$9o3qtf.sendEvent($n)
}}}}};var $g=$f.getUserData(this.datasizevar);var $h=$g==null?this.viewsize:$g;if($m[this.sizeAxis]!=$h){
{
var $lzsc$x7vwnu=this.sizeAxis;if(!$m.__LZdeleted){
var $lzsc$4mflte="$lzc$set_"+$lzsc$x7vwnu;if(Function["$lzsc$isa"]?Function.$lzsc$isa($m[$lzsc$4mflte]):$m[$lzsc$4mflte] instanceof Function){
$m[$lzsc$4mflte]($h)
}else{
$m[$lzsc$x7vwnu]=$h;var $lzsc$gmhsts=$m["on"+$lzsc$x7vwnu];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$gmhsts):$lzsc$gmhsts instanceof LzEvent){
if($lzsc$gmhsts.ready){
$lzsc$gmhsts.sendEvent($h)
}}}}}};$n+=$h+this.spacing
};this.__LZdataoffset=$5;{
var $lzsc$drhonf=this.cloneimmediateparent;var $lzsc$dfebe7=this.sizeAxis;if(!$lzsc$drhonf.__LZdeleted){
var $lzsc$os56gd="$lzc$set_"+$lzsc$dfebe7;if(Function["$lzsc$isa"]?Function.$lzsc$isa($lzsc$drhonf[$lzsc$os56gd]):$lzsc$drhonf[$lzsc$os56gd] instanceof Function){
$lzsc$drhonf[$lzsc$os56gd]($9)
}else{
$lzsc$drhonf[$lzsc$dfebe7]=$9;var $lzsc$17272g=$lzsc$drhonf["on"+$lzsc$dfebe7];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$17272g):$lzsc$17272g instanceof LzEvent){
if($lzsc$17272g.ready){
$lzsc$17272g.sendEvent($9)
...
var $5=$3[$4];{
var $lzsc$3hde2y=global[$5.c];var $lzsc$ti7b5v=$5.n;var $lzsc$7ym65d=$5.v;if(!$lzsc$3hde2y.__LZdeleted){
var $lzsc$98jsa8="$lzc$set_"+$lzsc$ti7b5v;if(Function["$lzsc$isa"]?Function.$lzsc$isa($lzsc$3hde2y[$lzsc$98jsa8]):$lzsc$3hde2y[$lzsc$98jsa8] instanceof Function){
$lzsc$3hde2y[$lzsc$98jsa8]($lzsc$7ym65d)
}else{
$lzsc$3hde2y[$lzsc$ti7b5v]=$lzsc$7ym65d;var $lzsc$dzyiis=$lzsc$3hde2y["on"+$lzsc$ti7b5v];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$dzyiis):$lzsc$dzyiis instanceof LzEvent){
if($lzsc$dzyiis.ready){
$lzsc$dzyiis.sendEvent($lzsc$7ym65d)
}}}}}};this.offset=$2;if(this.onoffset.ready)this.onoffset.sendEvent($2);return $2
},"receiveEvent",function($0,$1){
{
if(!canvas.__LZdeleted){
var $lzsc$4808c9="$lzc$set_"+$0;if(Function["$lzsc$isa"]?Function.$lzsc$isa(canvas[$lzsc$4808c9]):canvas[$lzsc$4808c9] instanceof Function){
canvas[$lzsc$4808c9]($1)
}else{
canvas[$0]=$1;var $lzsc$6ivxe4=canvas["on"+$0];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$6ivxe4):$lzsc$6ivxe4 instanceof LzEvent){
if($lzsc$6ivxe4.ready){
$lzsc$6ivxe4.sendEvent($1)
...
this["width"]=$1;var $lzsc$o7695h=this["onwidth"];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$o7695h):$lzsc$o7695h instanceof LzEvent){
if($lzsc$o7695h.ready){
$lzsc$o7695h.sendEvent($1)
}}}}}}},"$bf5pjd8",function(){
try{
...
this["height"]=$1;var $lzsc$nsutrw=this["onheight"];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$nsutrw):$lzsc$nsutrw instanceof LzEvent){
if($lzsc$nsutrw.ready){
$lzsc$nsutrw.sendEvent($1)
}}}}}}},"$bf5pjda",function(){
try{
...
var $lzsc$d5tgmf=$0.x;if(!this.__LZdeleted){
if(Function["$lzsc$isa"]?Function.$lzsc$isa(this["$lzc$set_x"]):this["$lzc$set_x"] instanceof Function){
this["$lzc$set_x"]($lzsc$d5tgmf)
}else{
this["x"]=$lzsc$d5tgmf;var $lzsc$gq32em=this["onx"];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$gq32em):$lzsc$gq32em instanceof LzEvent){
if($lzsc$gq32em.ready){
$lzsc$gq32em.sendEvent($lzsc$d5tgmf)
}}}}};{
var $lzsc$q3wi74=$0.y;if(!this.__LZdeleted){
if(Function["$lzsc$isa"]?Function.$lzsc$isa(this["$lzc$set_y"]):this["$lzc$set_y"] instanceof Function){
this["$lzc$set_y"]($lzsc$q3wi74)
}else{
this["y"]=$lzsc$q3wi74;var $lzsc$h3prve=this["ony"];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$h3prve):$lzsc$h3prve instanceof LzEvent){
if($lzsc$h3prve.ready){
$lzsc$h3prve.sendEvent($lzsc$q3wi74)
}}}}};{
if(!this.__LZdeleted){
...
this["visible"]=true;var $lzsc$myyf6=this["onvisible"];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$myyf6):$lzsc$myyf6 instanceof LzEvent){
if($lzsc$myyf6.ready){
$lzsc$myyf6.sendEvent(true)
...
this["visible"]=false;var $lzsc$gbj7b=this["onvisible"];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$gbj7b):$lzsc$gbj7b instanceof LzEvent){
if($lzsc$gbj7b.ready){
$lzsc$gbj7b.sendEvent(false)
}}}}}},"setItems",function($0){
...
$8["y"]=$5;var $lzsc$ph9lce=$8["ony"];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$ph9lce):$lzsc$ph9lce instanceof LzEvent){
if($lzsc$ph9lce.ready){
$lzsc$ph9lce.sendEvent($5)
}}}}};$5+=$8.height

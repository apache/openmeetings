...
package fl.video {
	...
	public interface INCManager {
		...
		/**
		 * Sets the <code>streams</code> array that Flash Media Server uses for dynamic streaming.
         * @param dsi A DynamicStreamItem object. A DynamicStreamItem object is an array of streams Flash Media Server
         * uses for dynamic streaming. For more information, see <a href="http://www.adobe.com/go/fms_dynamicstreaming">
         * www.adobe.com/go/fms_dynamicstreaming</a>.
         *
         * @langversion 3.0
        ...
        /**
         * Whether the URL is for RTMP streaming from Flash Media Server
         * or a progressive download. If the
         * stream is an RTMP stream from Flash Media Server, then <code>true</code>. If the stream is a
         ...
         * <code>VideoPlayer.load()</code> method or information received from the file's metadata.
         *
         * @see VideoPlayer#ncConnected()
		...
		/**
		 * Gets the list of streams used for dynamic streaming.
		 * @return streams
         *
         * @langversion 3.0
         * @playerversion Flash 10

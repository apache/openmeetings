...
var $lzsc$1803189946 = "$lzc$set_" + dest_$2;
if (Function["$lzsc$isa"] ? Function.$lzsc$isa(target_$1[$lzsc$1803189946]) : target_$1[$lzsc$1803189946] instanceof Function) {
target_$1[$lzsc$1803189946](newvalue_$4)
} else {
target_$1[dest_$2] = newvalue_$4;
var $lzsc$1467537184 = target_$1["on" + dest_$2];
if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$1467537184) : $lzsc$1467537184 instanceof LzEvent) {
if ($lzsc$1467537184.ready) {
$lzsc$1467537184.sendEvent(newvalue_$4)
}}}}}}};
...
{
if (!this.__LZdeleted) {
var $lzsc$1344728327 = "$lzc$set_" + attr_$0;
if (Function["$lzsc$isa"] ? Function.$lzsc$isa(this[$lzsc$1344728327]) : this[$lzsc$1344728327] instanceof Function) {
this[$lzsc$1344728327](styleValue_$7)
} else {
this[attr_$0] = styleValue_$7;
var $lzsc$1309817539 = this["on" + attr_$0];
if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$1309817539) : $lzsc$1309817539 instanceof LzEvent) {
if ($lzsc$1309817539.ready) {
$lzsc$1309817539.sendEvent(styleValue_$7)
...
{
if (!this.__LZdeleted) {
var $lzsc$559977440 = "$lzc$set_" + attr_$0;
if (Function["$lzsc$isa"] ? Function.$lzsc$isa(this[$lzsc$559977440]) : this[$lzsc$559977440] instanceof Function) {
this[$lzsc$559977440](fallback_$3)
} else {
this[attr_$0] = fallback_$3;
var $lzsc$2049822906 = this["on" + attr_$0];
if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$2049822906) : $lzsc$2049822906 instanceof LzEvent) {
if ($lzsc$2049822906.ready) {
$lzsc$2049822906.sendEvent(fallback_$3)
}}}}}}};
...
{
if (!this.__LZdeleted) {
var $lzsc$818054657 = "$lzc$set_" + prop_$0;
if (Function["$lzsc$isa"] ? Function.$lzsc$isa(this[$lzsc$818054657]) : this[$lzsc$818054657] instanceof Function) {
this[$lzsc$818054657](val_$5)
} else {
this[prop_$0] = val_$5;
var $lzsc$1926454622 = this["on" + prop_$0];
if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$1926454622) : $lzsc$1926454622 instanceof LzEvent) {
if ($lzsc$1926454622.ready) {
$lzsc$1926454622.sendEvent(val_$5)
}}}}};
return null
};
...
{
if (!this.__LZdeleted) {
var $lzsc$1035773341 = "$lzc$set_" + name_$0;
if (Function["$lzsc$isa"] ? Function.$lzsc$isa(this[$lzsc$1035773341]) : this[$lzsc$1035773341] instanceof Function) {
this[$lzsc$1035773341](value_$2)
} else {
this[name_$0] = value_$2;
var $lzsc$1140563217 = this["on" + name_$0];
if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$1140563217) : $lzsc$1140563217 instanceof LzEvent) {
if ($lzsc$1140563217.ready) {
$lzsc$1140563217.sendEvent(value_$2)
}}}}}}};
...
if (this[attrname_$0]) {
if (!this.__LZdeleted) {
var $lzsc$1546174683 = "$lzc$set_" + attrname_$0;
if (Function["$lzsc$isa"] ? Function.$lzsc$isa(this[$lzsc$1546174683]) : this[$lzsc$1546174683] instanceof Function) {
this[$lzsc$1546174683](value_$1)
} else {
this[attrname_$0] = value_$1;
var $lzsc$95475930 = this["on" + attrname_$0];
if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$95475930) : $lzsc$95475930 instanceof LzEvent) {
if ($lzsc$95475930.ready) {
$lzsc$95475930.sendEvent(value_$1)
}}}}}};
...
{
var $lzsc$1906221768 = (val_$3 - tLink_$2.offset[prop_$0]) / tLink_$2.scale[prop_$0];
if (!this.__LZdeleted) {
var $lzsc$1959912429 = "$lzc$set_" + prop_$0;
if (Function["$lzsc$isa"] ? Function.$lzsc$isa(this[$lzsc$1959912429]) : this[$lzsc$1959912429] instanceof Function) {
this[$lzsc$1959912429]($lzsc$1906221768)
} else {
this[prop_$0] = $lzsc$1906221768;
var $lzsc$966732548 = this["on" + prop_$0];
if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$966732548) : $lzsc$966732548 instanceof LzEvent) {
if ($lzsc$966732548.ready) {
$lzsc$966732548.sendEvent($lzsc$1906221768)
}}}}}} else if (prop_$0 == "width" || prop_$0 == "height") {
var axis_$4 = prop_$0 == "width" ? "x" : "y";
tLink_$2.update(axis_$4);
{
var $lzsc$752231037 = val_$3 / tLink_$2.scale[axis_$4];
if (!this.__LZdeleted) {
var $lzsc$307092767 = "$lzc$set_" + prop_$0;
if (Function["$lzsc$isa"] ? Function.$lzsc$isa(this[$lzsc$307092767]) : this[$lzsc$307092767] instanceof Function) {
this[$lzsc$307092767]($lzsc$752231037)
} else {
this[prop_$0] = $lzsc$752231037;
var $lzsc$2090675899 = this["on" + prop_$0];
if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$2090675899) : $lzsc$2090675899 instanceof LzEvent) {
if ($lzsc$2090675899.ready) {
$lzsc$2090675899.sendEvent($lzsc$752231037)
}}}}}}};
...
this["context"] = context_$0;
var $lzsc$936517689 = this["oncontext"];
if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$936517689) : $lzsc$936517689 instanceof LzEvent) {
if ($lzsc$936517689.ready) {
$lzsc$936517689.sendEvent(context_$0)
}}}}}}} else {
...
if (this.from != null) {
{
var $lzsc$1844086685 = Number(this.from);
if (!targ_$0.__LZdeleted) {
var $lzsc$935942331 = "$lzc$set_" + attr_$1;
if (Function["$lzsc$isa"] ? Function.$lzsc$isa(targ_$0[$lzsc$935942331]) : targ_$0[$lzsc$935942331] instanceof Function) {
targ_$0[$lzsc$935942331]($lzsc$1844086685)
} else {
targ_$0[attr_$1] = $lzsc$1844086685;
var $lzsc$1798887121 = targ_$0["on" + attr_$1];
if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$1798887121) : $lzsc$1798887121 instanceof LzEvent) {
if ($lzsc$1798887121.ready) {
$lzsc$1798887121.sendEvent($lzsc$1844086685)
}}}}}};
if (this.relative) {
this.to = this.origto
} else {
...
{
if (!targ_$0.__LZdeleted) {
var $lzsc$1055455800 = "$lzc$set_" + attr_$1;
if (Function["$lzsc$isa"] ? Function.$lzsc$isa(targ_$0[$lzsc$1055455800]) : targ_$0[$lzsc$1055455800] instanceof Function) {
targ_$0[$lzsc$1055455800](from_$2)
} else {
targ_$0[attr_$1] = from_$2;
var $lzsc$1150875195 = targ_$0["on" + attr_$1];
if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$1150875195) : $lzsc$1150875195 instanceof LzEvent) {
if ($lzsc$1150875195.ready) {
$lzsc$1150875195.sendEvent(from_$2)
}}}}};
...
targ_$0[e_prop_$2].c = 0;
{
var $lzsc$1747589843 = targ_$0[e_prop_$2].v;
if (!targ_$0.__LZdeleted) {
var $lzsc$205789460 = "$lzc$set_" + attr_$1;
if (Function["$lzsc$isa"] ? Function.$lzsc$isa(targ_$0[$lzsc$205789460]) : targ_$0[$lzsc$205789460] instanceof Function) {
targ_$0[$lzsc$205789460]($lzsc$1747589843)
} else {
targ_$0[attr_$1] = $lzsc$1747589843;
var $lzsc$257703136 = targ_$0["on" + attr_$1];
if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$257703136) : $lzsc$257703136 instanceof LzEvent) {
if ($lzsc$257703136.ready) {
$lzsc$257703136.sendEvent($lzsc$1747589843)
}}}}};
...
{
var $lzsc$1776540025 = targ_$1[attr_$2] + aDiff_$3;
if (!targ_$1.__LZdeleted) {
var $lzsc$956587974 = "$lzc$set_" + attr_$2;
if (Function["$lzsc$isa"] ? Function.$lzsc$isa(targ_$1[$lzsc$956587974]) : targ_$1[$lzsc$956587974] instanceof Function) {
targ_$1[$lzsc$956587974]($lzsc$1776540025)
} else {
targ_$1[attr_$2] = $lzsc$1776540025;
var $lzsc$899696463 = targ_$1["on" + attr_$2];
if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$899696463) : $lzsc$899696463 instanceof LzEvent) {
if ($lzsc$899696463.ready) {
$lzsc$899696463.sendEvent($lzsc$1776540025)
}}}}};
...
var $lzsc$476513271 = "$lzc$set_" + attr_$6;
if (Function["$lzsc$isa"] ? Function.$lzsc$isa(node_$5[$lzsc$476513271]) : node_$5[$lzsc$476513271] instanceof Function) {
node_$5[$lzsc$476513271](newvalue_$7)
} else {
node_$5[attr_$6] = newvalue_$7;
var $lzsc$953580010 = node_$5["on" + attr_$6];
if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$953580010) : $lzsc$953580010 instanceof LzEvent) {
if ($lzsc$953580010.ready) {
$lzsc$953580010.sendEvent(newvalue_$7)
}}}}}}};
return result_$3
};
$lzsc$temp["displayName"] = "__LZsendUpdate";
...
{
var $lzsc$1397186596 = this.axis;
var $lzsc$1057300981 = this.totalsize;
if (!v_$6.__LZdeleted) {
var $lzsc$237387843 = "$lzc$set_" + $lzsc$1397186596;
if (Function["$lzsc$isa"] ? Function.$lzsc$isa(v_$6[$lzsc$237387843]) : v_$6[$lzsc$237387843] instanceof Function) {
v_$6[$lzsc$237387843]($lzsc$1057300981)
} else {
v_$6[$lzsc$1397186596] = $lzsc$1057300981;
var $lzsc$469741694 = v_$6["on" + $lzsc$1397186596];
if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$469741694) : $lzsc$469741694 instanceof LzEvent) {
if ($lzsc$469741694.ready) {
$lzsc$469741694.sendEvent($lzsc$1057300981)
}}}}};
...
{
var $lzsc$1090950256 = nodelen_$7 * _totalsize_$6 - this.spacing;
if (!cloneip_$2.__LZdeleted) {
var $lzsc$908636969 = "$lzc$set_" + _sizeAxis_$5;
if (Function["$lzsc$isa"] ? Function.$lzsc$isa(cloneip_$2[$lzsc$908636969]) : cloneip_$2[$lzsc$908636969] instanceof Function) {
cloneip_$2[$lzsc$908636969]($lzsc$1090950256)
} else {
cloneip_$2[_sizeAxis_$5] = $lzsc$1090950256;
var $lzsc$437910869 = cloneip_$2["on" + _sizeAxis_$5];
if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$437910869) : $lzsc$437910869 instanceof LzEvent) {
if ($lzsc$437910869.ready) {
$lzsc$437910869.sendEvent($lzsc$1090950256)
}}}}};
...
{
var $lzsc$302609115 = (i_$f + newstart_$8) * _totalsize_$6;
if (!cl_$g.__LZdeleted) {
var $lzsc$1724995289 = "$lzc$set_" + _axis_$4;
if (Function["$lzsc$isa"] ? Function.$lzsc$isa(cl_$g[$lzsc$1724995289]) : cl_$g[$lzsc$1724995289] instanceof Function) {
cl_$g[$lzsc$1724995289]($lzsc$302609115)
} else {
cl_$g[_axis_$4] = $lzsc$302609115;
var $lzsc$1742388503 = cl_$g["on" + _axis_$4];
if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$1742388503) : $lzsc$1742388503 instanceof LzEvent) {
if ($lzsc$1742388503.ready) {
$lzsc$1742388503.sendEvent($lzsc$302609115)
}}}}};
...
this.clones[i_$e] = cl_$m;
{
var $lzsc$1402263454 = this.axis;
if (!cl_$m.__LZdeleted) {
var $lzsc$1367950869 = "$lzc$set_" + $lzsc$1402263454;
if (Function["$lzsc$isa"] ? Function.$lzsc$isa(cl_$m[$lzsc$1367950869]) : cl_$m[$lzsc$1367950869] instanceof Function) {
cl_$m[$lzsc$1367950869](clpos_$n)
} else {
cl_$m[$lzsc$1402263454] = clpos_$n;
var $lzsc$1447417448 = cl_$m["on" + $lzsc$1402263454];
if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$1447417448) : $lzsc$1447417448 instanceof LzEvent) {
if ($lzsc$1447417448.ready) {
$lzsc$1447417448.sendEvent(clpos_$n)
}}}}};
var ds_$g = cnode_$f.getUserData(this.datasizevar);
var csiz_$h = ds_$g == null ? this.viewsize : ds_$g;
if (cl_$m[this.sizeAxis] != csiz_$h) {
{
var $lzsc$601945222 = this.sizeAxis;
if (!cl_$m.__LZdeleted) {
var $lzsc$1185294483 = "$lzc$set_" + $lzsc$601945222;
if (Function["$lzsc$isa"] ? Function.$lzsc$isa(cl_$m[$lzsc$1185294483]) : cl_$m[$lzsc$1185294483] instanceof Function) {
cl_$m[$lzsc$1185294483](csiz_$h)
} else {
cl_$m[$lzsc$601945222] = csiz_$h;
var $lzsc$1741611891 = cl_$m["on" + $lzsc$601945222];
if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$1741611891) : $lzsc$1741611891 instanceof LzEvent) {
if ($lzsc$1741611891.ready) {
$lzsc$1741611891.sendEvent(csiz_$h)
}}}}}};
clpos_$n += csiz_$h + this.spacing
};
this.__LZdataoffset = newoffset_$5;
{
var $lzsc$475049026 = this.cloneimmediateparent;
var $lzsc$2058732469 = this.sizeAxis;
if (!$lzsc$475049026.__LZdeleted) {
var $lzsc$1760789157 = "$lzc$set_" + $lzsc$2058732469;
if (Function["$lzsc$isa"] ? Function.$lzsc$isa($lzsc$475049026[$lzsc$1760789157]) : $lzsc$475049026[$lzsc$1760789157] instanceof Function) {
$lzsc$475049026[$lzsc$1760789157](cpos_$9)
} else {
$lzsc$475049026[$lzsc$2058732469] = cpos_$9;
var $lzsc$1871936388 = $lzsc$475049026["on" + $lzsc$2058732469];
if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$1871936388) : $lzsc$1871936388 instanceof LzEvent) {
if ($lzsc$1871936388.ready) {
$lzsc$1871936388.sendEvent(cpos_$9)
}}}}};
...
{
var $lzsc$607074579 = global[obj_$5.c];
var $lzsc$174286753 = obj_$5.n;
var $lzsc$1073495803 = obj_$5.v;
if (!$lzsc$607074579.__LZdeleted) {
var $lzsc$1279075492 = "$lzc$set_" + $lzsc$174286753;
if (Function["$lzsc$isa"] ? Function.$lzsc$isa($lzsc$607074579[$lzsc$1279075492]) : $lzsc$607074579[$lzsc$1279075492] instanceof Function) {
$lzsc$607074579[$lzsc$1279075492]($lzsc$1073495803)
} else {
$lzsc$607074579[$lzsc$174286753] = $lzsc$1073495803;
var $lzsc$1217747829 = $lzsc$607074579["on" + $lzsc$174286753];
if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$1217747829) : $lzsc$1217747829 instanceof LzEvent) {
if ($lzsc$1217747829.ready) {
$lzsc$1217747829.sendEvent($lzsc$1073495803)
}}}}}};
...
var $lzsc$812228868 = "$lzc$set_" + n_$0;
if (Function["$lzsc$isa"] ? Function.$lzsc$isa(canvas[$lzsc$812228868]) : canvas[$lzsc$812228868] instanceof Function) {
canvas[$lzsc$812228868](v_$1)
} else {
canvas[n_$0] = v_$1;
var $lzsc$30528220 = canvas["on" + n_$0];
if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$30528220) : $lzsc$30528220 instanceof LzEvent) {
if ($lzsc$30528220.ready) {
$lzsc$30528220.sendEvent(v_$1)
}}}}}};
...
this["width"] = $1;
var $lzsc$156134623 = this["onwidth"];
if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$156134623) : $lzsc$156134623 instanceof LzEvent) {
if ($lzsc$156134623.ready) {
$lzsc$156134623.sendEvent($1)
}}}}}}}};
...
this["height"] = $1;
var $lzsc$821503830 = this["onheight"];
if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$821503830) : $lzsc$821503830 instanceof LzEvent) {
if ($lzsc$821503830.ready) {
$lzsc$821503830.sendEvent($1)
}}}}}}}};
...
this.bringToFront();
{
var $lzsc$1322081994 = $0.x;
if (!this.__LZdeleted) {
if (Function["$lzsc$isa"] ? Function.$lzsc$isa(this["$lzc$set_x"]) : this["$lzc$set_x"] instanceof Function) {
this["$lzc$set_x"]($lzsc$1322081994)
} else {
this["x"] = $lzsc$1322081994;
var $lzsc$2004543004 = this["onx"];
if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$2004543004) : $lzsc$2004543004 instanceof LzEvent) {
if ($lzsc$2004543004.ready) {
$lzsc$2004543004.sendEvent($lzsc$1322081994)
}}}}};
{
var $lzsc$686367159 = $0.y;
if (!this.__LZdeleted) {
if (Function["$lzsc$isa"] ? Function.$lzsc$isa(this["$lzc$set_y"]) : this["$lzc$set_y"] instanceof Function) {
this["$lzc$set_y"]($lzsc$686367159)
} else {
this["y"] = $lzsc$686367159;
var $lzsc$1736647820 = this["ony"];
if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$1736647820) : $lzsc$1736647820 instanceof LzEvent) {
if ($lzsc$1736647820.ready) {
$lzsc$1736647820.sendEvent($lzsc$686367159)
}}}}};
{
if (!this.__LZdeleted) {
...
this["visible"] = true;
var $lzsc$967713776 = this["onvisible"];
if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$967713776) : $lzsc$967713776 instanceof LzEvent) {
if ($lzsc$967713776.ready) {
$lzsc$967713776.sendEvent(true)
}}}}};
...
this["visible"] = false;
var $lzsc$169784807 = this["onvisible"];
if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$169784807) : $lzsc$169784807 instanceof LzEvent) {
if ($lzsc$169784807.ready) {
$lzsc$169784807.sendEvent(false)
}}}}}}};
...
$8["y"] = $5;
var $lzsc$688723683 = $8["ony"];
if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$688723683) : $lzsc$688723683 instanceof LzEvent) {
if ($lzsc$688723683.ready) {
$lzsc$688723683.sendEvent($5)
}}}}};
$5 += $8.height
}};
this.items = $0;
